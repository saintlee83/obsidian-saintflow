...
const EN: Record<string, string> = {
	...
	"C13 Resource에서 Zettel 추출": "C13 Extract Zettel from Resource",
	...
	"지금 신경 쓰이는 것을 한 줄로 적습니다. 무엇인지는 나중에 분류에서 정합니다.": "Write down what is on your mind in one line. What it is gets decided later, in Arrange.",
	...
	"| 점검 | 개수 |": "| Check | Count |",
	"- 없음": "- none",
	"1. 행동인가? → Task. 여러 행동이 필요하면 프로젝트": "1. Is it an action? → Task. If it needs several actions, a Project",
	"2. 결과물인가? → Output, 관계는 속성으로 기록": "2. Is it a deliverable? → Output, with relations in properties.",
	"3. 자료가 말하는 것을 정리했는가? → Resource": "3. Are you recording what a source says? → Resource",
	"4. 내가 이해한 것을 자기 말로 썼는가? → Zettel": "4. Are you writing what you understood in your own words? → Zettel",
	...
	"주장 문장으로 씁니다. 항목 문구가 후보로 들어가 있습니다.": "Write it as a claim. The item text is filled in as a starting point.",
	"제목이 비어 있어 만들지 않았습니다.": "The title was empty, so nothing was created.",
	"속성 상속": "Inherit properties",
	"Resource의 {0}을(를) 새 Zettel에도 넣을까요?": "Copy {0} from the Resource to the new Zettel?",
	"추출: {0}": "Extracted: {0}",
	"승격할 텍스트를 먼저 고르세요.": "Select the text to promote first.",
	"고른 텍스트가 생각 섹션으로 갑니다. seed로 만듭니다.": "The selected text goes into the thought section, as a seed.",
	"고른 텍스트가 요약 섹션으로 갑니다.": "The selected text goes into the summary section.",
	"무엇으로 승격할까요?": "Promote it to what?",
	"Resource 제목": "Resource title",
	"주장 문장으로 씁니다. 접두사는 붙이지 않습니다.": "Write it as a claim. Do not add a prefix.",
	"자료의 제목을 씁니다.": "Enter the resource title.",
	...
	"바꿀 노트가 없습니다. 본문은 어떤 경우에도 건드리지 않습니다.": "No note needs changing. The body is never touched.",
	"노트 {0}개에서 속성 {1}개를 추가하고 키 {2}개의 이름을 바꿉니다. 본문은 건드리지 않습니다.": "Adds {1} properties and renames {2} keys across {0} notes. The body is left alone.",
	"변경 미리보기 ({0})": "Preview of changes ({0})",
	"외 {0}개": "and {0} more",
	"보고만 하는 값 문제 ({0})": "Value problems, reported only ({0})",
	"허용값 밖의 값은 자동으로 바꾸지 않습니다. C15 규칙 검사에서 하나씩 고르세요.": "Values outside the allowed set are never rewritten for you. Pick them one by one in C15.",
	"버전만 맞추기": "Only set the version",
	"변경 없음. 스키마 버전을 v{0}로 맞췄습니다.": "Nothing changed. The schema version is now v{0}.",
	"{0}개 노트를 갱신했습니다. 자세한 내용은 콘솔 로그에 있습니다.": "Updated {0} notes. The details are in the console log.",
	...
	"Resource로 분류": "Arrange as Resource",
	"Zettel로 분류": "Arrange as Zettel",
	"제목은 주장 문장으로 씁니다. maturity는 seed로 시작합니다.": "Use a claim sentence as the title. Maturity starts at seed.",
	"주장 문장": "A claim",
	...
	"새 프로젝트": "New project",
	"완료 조건은 판정 가능한 한 문장이어야 합니다. 비면 만들지 않습니다.": "The completion criterion must be one checkable sentence. Empty means nothing is created.",
	...
	"새 영역": "New area",
	"영역은 유지 기준이 있는 책임입니다. 끝나는 날짜가 있으면 프로젝트입니다.": "An area is a responsibility with a standard to hold. If it has an end date, it is a project.",
	"첫 다음 행동": "First next action",
	"다음 행동이 없으면 멈춘 프로젝트로 표시됩니다. 지금 하나 정할까요?\n정할 수 없다면 그것을 정하기 위해 확인할 질문을 Task로 두세요.": "Without a next action this shows up as a stalled project. Decide one now?\nIf you cannot, make the question you need answered the Task.",
	"다음 행동": "Next action",
	...
	"연결: {0}": "Linked: {0}",
	"Task, Project, Area, Resource, Zettel, Output에서 쓸 수 있습니다.": "Available for Task, Project, Area, Resource, Zettel, and Output.",
	"(현재)": "(current)",
	"{0} 상태": "Status of {0}",
	"대기 대상": "Waiting on",
	...
	"종료는 수확과 보관까지 함께 해야 합니다. 'SaintFlow: 프로젝트 종료(C9)'를 쓰는 편이 안전합니다. 그래도 상태만 바꿀까요?": "Closing also means harvesting and archiving. 'C9 Close project' is the safe way. Change only the status anyway?",
	"상태만 바꾸기": "Change only the status",
	"evergreen으로 올리지 않았습니다.": "Not promoted to evergreen.",
	"uses가 비어 있습니다": "uses is empty",
	"완료 증거는 결과물에 사용한 지식 링크입니다(설계안 1.6). uses 없이 shipped로 둘까요?": "The evidence of completion is the knowledge an output used (1.6). Ship it with an empty uses?",
	"그대로 shipped": "Ship it anyway",
	"질문: {0}": "Question: {0}",
	"답안:": "Answer:",
	"판정:": "Verdict:",
	"회상 세션 {0}: {1}건": "Recall session {0}: {1} due",
	"핵심 주장, 근거, 적용 사례 또는 반례를 모두 썼습니다.": "You wrote the claim, the evidence, and an application or a counterexample.",
	...
	"보관된 {0} [[{1}]]을(를) 가리키는 활성 Task입니다.": "An active Task pointing at the archived {0} [[{1}]].",
	...
	"파일명 규칙을 적용하면 이름이 비어 있습니다. 다른 제목을 쓰세요.": "Applying the naming rule leaves an empty name. Use a different title.",
	"Zettel 제목이 {0}자입니다. {1}자 안팎을 권장합니다.": "This Zettel title is {0} characters. About {1} is recommended.",
	...
	"box 1부터 순서대로 쓸 간격(일)입니다. 쉼표로 구분합니다.": "Days between reviews, from box 1 upwards. Separate them with commas.",
	"오래된 seed 임계값": "Old seed threshold",
	"seed 상태로 이 일수를 넘긴 Zettel을 점검에서 표시합니다.": "Checks flag a Zettel that has been a seed for more days than this.",
	"시작과 화면": "Startup and screen",
	"시작 시 Home 열기": "Open Home on startup",
	"C17. Obsidian을 열면 Home 노트를 활성 탭으로 띄웁니다.": "C17. Makes the Home note the active tab when Obsidian opens.",
	"Home 경로": "Home path",
	"파일 탐색기에서 허브 구분 표시": "Mark hubs in the file explorer",
	"C18. 방 노트와 Project, Area를 굵게 표시합니다.": "C18. Show stage rooms, Projects, and Areas in bold.",
	"시작 시 규칙 검사": "Check rules on startup",
	"C15. Obsidian을 열 때 vault를 검사하고 위반 수를 알립니다.": "C15. Scans the vault when Obsidian opens and reports how many violations there are.",
	"이동·이름 변경 시 규칙 검사": "Check rules on move and rename",
	"C15. 파일을 옮기거나 이름을 바꿀 때 그 파일만 검사해 바로 알립니다.": "C15. Checks just that file when you move or rename it, and tells you right away.",
	"주간 검토 시 리포트 저장": "Save a report with the weekly review",
	"C20. C10을 실행하면 점검 리포트 JSON을 함께 저장합니다.": "C20. Running C10 also writes the check report as JSON.",
	"스키마 버전": "Schema version",
	"현재 플러그인 스키마는 v{0}, 이 vault에 맞춘 버전은 v{1}입니다.": "The plugin schema is v{0}; this vault was last matched to v{1}.",
	"C19 마이그레이션 실행": "Run the C19 migration",
	"폴더 경로": "Folder paths",
	"파일명 접두사": "File name prefixes",
	"기본값으로 되돌리기": "Restore the defaults",
	"폴더, 접두사, 회상 간격을 SaintFlow Manual 기본값으로 돌립니다.": "Reset folders, prefixes, and recall intervals to the SaintFlow Manual defaults.",
	"고를 수 있는 노트가 없습니다.": "There is no note to pick.",
	"{0}은(는) 필수입니다.": "{0} is required.",
	"폴더를 만들 수 없습니다. 같은 이름의 파일이 있습니다: {0}": "Cannot create the folder: a file of the same name exists: {0}",
	...
	"연결된 부모나 방 노트가 없습니다.": "No linked parent or stage room was found.",
	"수집": "Capture",
	"분류한다": "Arrange it",
	"건너뛰기": "Skip",
	"삭제": "Delete",
	"그만두기": "Stop",
	"휴지통으로": "To the trash",
	"\"{0}\"을(를) 지금 처리했습니까?\n완료한 Task로 기록하고 4_Transform으로 옮깁니다.": "Did you just handle \"{0}\"?\nIt is recorded as a completed Task and moved to 4_Transform.",
	"만들기": "Create",
	"상속": "Inherit",
	"승격": "Promote",
	"SaintFlow 규칙 위반 {0}건. \"C15 규칙 검사\"로 확인하세요.": "SaintFlow rule violations: {0}. Run \"C15 Check rules\" to see them.",
	"닫기": "Close",
	"취소": "Cancel",
	"적용": "Apply",
	"SaintFlow 스키마가 v{0}로 올랐습니다. \"C19 스키마 마이그레이션\"을 실행하세요.": "The SaintFlow schema moved to v{0}. Run \"C19 Migrate schema\".",
	"제목": "Title",
	"분류": "Arrange",
	"이름": "Name",
	"원제목": "Original title",
	"주제": "Subject",
	"새 Zettel이 \"{0}\"과(와) 어떻게 이어지는지 한 줄로 씁니다.": "Write in one line how the new Zettel connects to \"{0}\".",
	"다음": "Next",
	"행동": "Action",
	"기술비교보고서": "Technology comparison report",
	"학업": "Study",
	"정하기": "Decide it",
	"\"{0}\"과(와) \"{1}\"을(를) 잇는 이유를 한 줄로 씁니다.": "Write in one line why \"{0}\" and \"{1}\" belong together.",
	"연결": "Link",
	"저장": "Save",
	"수집함": "Inbox",
	"본문": "body",
